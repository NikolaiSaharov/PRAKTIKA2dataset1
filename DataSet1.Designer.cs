...
SELECT TicketId, PassengerId, SeatNumber, Class, Price FROM Tickets WHERE (TicketId = @TicketId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = @"DELETE FROM [dbo].[Tickets] WHERE (([TicketId] = @Original_TicketId) AND ((@IsNull_PassengerId = 1 AND [PassengerId] IS NULL) OR ([PassengerId] = @Original_PassengerId)) AND ([SeatNumber] = @Original_SeatNumber) AND ([Class] = @Original_Class) AND ([Price] = @Original_Price))";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            ...
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "INSERT INTO [dbo].[Tickets] ([PassengerId], [SeatNumber], [Class], [Price]) VALUE" +
                "S (@PassengerId, @SeatNumber, @Class, @Price);\r\n";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            ...
            this._commandCollection[3] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[3].Connection = this.Connection;
            this._commandCollection[3].CommandText = @"UPDATE [dbo].[Tickets] SET [PassengerId] = @PassengerId, [SeatNumber] = @SeatNumber, [Class] = @Class, [Price] = @Price WHERE (([TicketId] = @Original_TicketId) AND ((@IsNull_PassengerId = 1 AND [PassengerId] IS NULL) OR ([PassengerId] = @Original_PassengerId)) AND ([SeatNumber] = @Original_SeatNumber) AND ([Class] = @Original_Class) AND ([Price] = @Original_Price));
";
            this._commandCollection[3].CommandType = global::System.Data.CommandType.Text;
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, false)]
        public virtual int DeleteQuery(int Original_TicketId, global::System.Nullable<int> IsNull_PassengerId, global::System.Nullable<int> Original_PassengerId, string Original_SeatNumber, string Original_Class, decimal Original_Price) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[1];
            ...
            if ((Original_SeatNumber == null)) {
                ...
                command.Parameters[3].Value = ((string)(Original_SeatNumber));
            }
            if ((Original_Class == null)) {
                throw new global::System.ArgumentNullException("Original_Class");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, false)]
        public virtual int InsertQuery(global::System.Nullable<int> PassengerId, string SeatNumber, string Class, decimal Price) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[2];
            if ((PassengerId.HasValue == true)) {
            ...
            if ((SeatNumber == null)) {
                ...
                command.Parameters[1].Value = ((string)(SeatNumber));
            }
            if ((Class == null)) {
                throw new global::System.ArgumentNullException("Class");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, false)]
        public virtual int UpdateQuery(global::System.Nullable<int> PassengerId, string SeatNumber, string Class, decimal Price, int Original_TicketId, global::System.Nullable<int> IsNull_PassengerId, string Original_SeatNumber, string Original_Class, decimal Original_Price) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[3];
            if ((PassengerId.HasValue == true)) {
                command.Parameters[0].Value = ((int)(PassengerId.Value));
            }
            ...
            command.Parameters[3].Value = ((decimal)(Price));
            command.Parameters[4].Value = ((int)(Original_TicketId));
            if ((IsNull_PassengerId.HasValue == true)) {
                command.Parameters[5].Value = ((int)(IsNull_PassengerId.Value));
            }
            else {
                command.Parameters[5].Value = global::System.DBNull.Value;
            }
            if ((Original_SeatNumber == null)) {
                ...
                command.Parameters[6].Value = ((string)(Original_SeatNumber));
            }
            if ((Original_Class == null)) {
                throw new global::System.ArgumentNullException("Original_Class");
            }
            else {
                command.Parameters[7].Value = ((string)(Original_Class));
            }
        ...
        internal void DeleteQuery(int ticketId, string originalSeatNumber, string originalClass, decimal originalPrice)
        {
            throw new NotImplementedException();
        }

        internal void UpdateQuery(string seatNumber, string ticketClass, decimal price, int ticketId, string originalSeatNumber, string originalClass, decimal originalPrice)
        {
            throw new NotImplementedException();
        }

        internal void InsertQuery(string seatBunber, string @class, string price)
        {
            throw new NotImplementedException();
        }

        internal void Insert(string seatBunber, string @class, string price)
        {
            throw new NotImplementedException();
        }

        internal void Update(string seatBunber, string @class, string price, string originalSeatNumber, string originalClass, string originalPrice)
        {
            throw new NotImplementedException();
        }

        internal void Update(string seatNumber, string @class, string price, int ticketsId, string originalSeatNumber, string originalClass, string originalPrice)
        {
            throw new NotImplementedException();
        }

        internal void Delete(int ticketsId, string originalSeatNumber, string originalClass, string originalPrice)
        {
            throw new NotImplementedException();
        }
    }
